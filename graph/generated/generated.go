...
type ComplexityRoot struct {
	...
	Mutation struct {
		AddAmenity func(childComplexity int, input model.NewAmenity) int
	}
...
type AmenityResolver interface {
	Photos(ctx context.Context, obj *model.Amenity) ([]string, error)
}
type MutationResolver interface {
	AddAmenity(ctx context.Context, input model.NewAmenity) (string, error)
}
...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Amenity.photos":
		if e.complexity.Amenity.Photos == nil {
			break
		}

		return e.complexity.Amenity.Photos(childComplexity), true
...
func (ec *executionContext) field_Mutation_addAmenity_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	var arg0 model.NewAmenity
	if tmp, ok := rawArgs["input"]; ok {
		arg0, err = ec.unmarshalNNewAmenity2githubᚗcomᚋalexpashkovᚋaschedᚋgraphᚋmodelᚐNewAmenity(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) _Amenity_photos(ctx context.Context, field graphql.CollectedField, obj *model.Amenity) (ret graphql.Marshaler) {
	defer func() {
		if r := recover(); r != nil {
			ec.Error(ctx, ec.Recover(ctx, r))
			ret = graphql.Null
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Amenity().Photos(rctx, obj)
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) _Mutation_addAmenity(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	args, err := ec.field_Mutation_addAmenity_args(ctx, rawArgs)
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
	}
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		ctx = rctx // use context from middleware stack in children
		return ec.resolvers.Mutation().AddAmenity(rctx, args["input"].(model.NewAmenity))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
...
func (ec *executionContext) _Query_amenities(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalOAmenity2ᚕᚖgithubᚗcomᚋalexpashkovᚋaschedᚋgraphᚋmodelᚐAmenityᚄ(ctx, field.Selections, res)
}
...
func (ec *executionContext) unmarshalInputNewAmenity(ctx context.Context, obj interface{}) (model.NewAmenity, error) {
	var it model.NewAmenity
	...
	for i, field := range fields {
		...
		case "photos":
			...
			out.Concurrently(i, func() (res graphql.Marshaler) {
				...
				res = ec._Amenity_photos(ctx, field, obj)
				return res
			})
		default:
...
func (ec *executionContext) _Mutation(ctx context.Context, sel ast.SelectionSet) graphql.Marshaler {
	...
	for i, field := range fields {
		...
		case "addAmenity":
			out.Values[i] = ec._Mutation_addAmenity(ctx, field)
			if out.Values[i] == graphql.Null {
				invalids++
			}
		default:
...
func (ec *executionContext) unmarshalNNewAmenity2githubᚗcomᚋalexpashkovᚋaschedᚋgraphᚋmodelᚐNewAmenity(ctx context.Context, v interface{}) (model.NewAmenity, error) {
	return ec.unmarshalInputNewAmenity(ctx, v)
}
...
func (ec *executionContext) marshalOAmenity2ᚕᚖgithubᚗcomᚋalexpashkovᚋaschedᚋgraphᚋmodelᚐAmenityᚄ(ctx context.Context, sel ast.SelectionSet, v []*model.Amenity) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	ret := make(graphql.Array, len(v))
